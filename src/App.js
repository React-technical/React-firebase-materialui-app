...
//hooks (useState, useEffect)
  ...
  // App.js return contains layout of the web page (text field, buttons, list)
  return (
    <Container maxWidth="xs">

      <form noValidate>

        <TextField variant="outlined" margin="normal" required fullWidth id="todo" label="Enter Anthing you want to add" name="todo"
          autoFocus value={input}
          onChange={event => setInput(event.target.value)} />

        <Button type="submit" variant="contained" color="secondary" fullWidth onClick={addTodo} disabled={!input}
